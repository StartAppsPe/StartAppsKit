...
let package = Package(
    name: "StartAppsKit",
    dependencies: [
        .Package(url: "https://github.com/StartAppsPe/StartAppsKitLoadAction.git", versions: Version(0,1,0)..<Version(1, .max, .max)),
        ...
        .Package(url: "https://github.com/StartAppsPe/StartAppsKitAlerts.git", versions: Version(0,1,0)..<Version(1, .max, .max)),
